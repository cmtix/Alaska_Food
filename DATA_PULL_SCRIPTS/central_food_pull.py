...
REPO_ROOT = r"C:\Users\cmtix\Documents\GitHub\Alaska_Food"
...
def main() -> int:
    ...
    if RUN_WM:
        ...
        #print out the env variables to make sure we're getting them correctly: (bjt 2026-01-17)
        print("Bright API Key: " + bright_key)
        print("Snapshot ID: " + snapshot_id)
        print("WM Use Last: " + use_last)
        print("Max Wait: " + max_wait)
        print("Poll Every: " + poll_every)
