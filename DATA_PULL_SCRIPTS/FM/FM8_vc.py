# FM8_vc.py — hardened, env-based secrets, strict JSON, retry on 401, gentle rate limit
...
# ---------------------------------------------------------------------------
# Save to G: drive in month folder, same convention as before
# ---------------------------------------------------------------------------
now = datetime.now()
year = now.strftime("%Y")
...
dir_path = r"G:/.shortcut-targets-by-id/13TRPt8_RZFrfmQt9TVmdpJNyl7kRtluH/Data_Scraping/FredMeyer/"  # CMT directory path
